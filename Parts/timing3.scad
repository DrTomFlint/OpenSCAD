...
// ------------------------
//number_of_teeth = 240; // [10:100]
number_of_teeth = 200; // [10:100]
...
motor_shaft_diameter = 120; // (in mm)
toothed_part_length = 6.3; // [3:30] (in mm)
base_height = 1; // [0:30] (in mm)
base_diameter = 150;   // [10:50] (in mm)
