...
difference(){
  union(){
    ...
    hull(){
      translate([railX+tabHi/2+tabHi2/2,-railY-20,29/2])
      rotate([0,90,0])
      cylinder(r=6,h=tabHi2,$fn=88,center=true);

      #translate([railX+tabHi/2+tabHi2/2,-railY-8,29/2])
      rotate([0,90,0])
      cylinder(r=6,h=tabHi2,$fn=88,center=true);
    }
  ...
  // mounting block
  difference(){
    translate([railX+16.5+6,railY,12])
    cube([20,28,120],center=true);

    // cut for main collar
    translate([railX+53,railY,-6+5])
    cylinder(r=47.3/2+2,h=200,$fn=88,center=true);

    // cut for dovetails
    translate([railX+20,railY,16])
    rotate([0,90,0])
    linear_extrude(height=9,scale=[1,0.7]){
      square([122,8+0.15],center=true);
    }
  }
  
  hull(){
    translate([railX+16.5+4,railY-13,65])
    cube([16,2,10],center=true);
    
    translate([railX+tabHi/2+tabHi2/2,-railY-8,29/2])
    rotate([0,90,0])
    cylinder(r=6,h=3,$fn=88,center=true);
  }

  hull(){
    translate([railX+16.5+4,railY-13,-42])
    cube([16,2,10],center=true);
...
tabHi2=3;   // height of tabs on the shoe
  ...
  difference(){
    ...
    // barrel
    translate([0,0,16.5+4+4.5+4+7+36 -180])
    cylinder(r=47.3/2,h=130,$fn=88);
    
    // cut for tightening collar
    translate([railX+5,-0,0])
  ...
  translate([railX+36,22,0])
    ...
    difference(){
      ...
      translate([2,0,-10])
      rotate([90,0,0])
      cylinder(r=1.5,h=20,$fn=77,center=true);
    }
  translate([railX+36,-22,0])
    rotate([0,0,-140])
    difference(){
...
if(0){
  translate([railX+53,railY,sledZ-120])
  rotate([0,0,180])
  dremmel();
}
if(1){
...
if(0){
  translate([0,railY,sledZ-25])
  dremmelCollar();
}
if(0){
  translate([0,railY,sledZ+60])
  dremmelCollar2();
}
