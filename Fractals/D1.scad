//======================================================================
// D-size "Fairy Crystals"
//
// The original sierpinski code is copyright aeropic 2017
// Adapted to make a low base that displays the "crusaders cross"
//
// Download the latest version of OpenSCAD that you can get! I used
// OpenSCAD-2024.03.28.ai18952-x86_64.AppImage  
//
// Under Edit Preferences Features, enable fast-csg and manifold since
// that will make the render about 100x faster than the old OpenScad
// versions.  
//
...
module s7(){
  ...
  difference() {
    ...
    mirror([0,0,1])
    ss(order-1);
    // cut off most of the bottom
    translate([-120,-120,-200-bottom])
    cube([240,240,200]);
    // remove any spikes from the top
    translate([-120,-120,0])
    cube([240,240,200]);
  }
