...
module post1(){
    ...
    color("cyan")
    intersection(){
    cylinder(r1=3.1,r2=3.1,h=16,$fn=20);
        translate([-0.75,-5,0]) cube(size=[10,10,16]);
    }
    translate([0,0,16]) sphere(3.1,$fn=20);
}
...
translate([0,40,30-6]){
    difference(){
        union(){
            // main boss
            translate([0,0,-9])
            linear_extrude(height=5.2+4+9,scale=1)
            offset(r=15)
            ...
            // side posts
            for(q=[-3:4]){
                translate([47,-8.2+16.7*q,-9])
                post1();
            }
            for(q=[-3:4]){
                translate([-47,-8.2+16.7*q,-9])
                rotate([0,0,180]) post1();
            }
            
            for(q=[0:4]){
                translate([-33.5+16.7*q,-72,-9])
                rotate([0,0,-90]) post1();
            }
            for(q=[0:4]){
                translate([-33.5+16.7*q,72,-9])
        ...
        translate([0,0,-10])
        linear_extrude(height=6+10,scale=1)
        offset(r=13)
        square(size=[64,114],center=true);
