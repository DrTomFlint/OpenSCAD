...
module post2(){
    ...
    color("cyan")
    intersection(){
    cylinder(r1=3.1,r2=3.1,h=14,$fn=20);
        translate([-0.75,-5,0]) cube(size=[10,10,16]);
    }
    translate([0,0,0]) sphere(3.1,$fn=20);
}
...
translate([0,40,-5.2]){
    difference(){
        union(){
            // main boss
            linear_extrude(height=5.2+8+7,scale=1)
            offset(r=15)
            ...
            // side posts
            for(q=[-3:4]){
                translate([47,-8.2+16.7*q,6.2])
                post2();
            }
            for(q=[-3:4]){
                translate([-47,-8.2+16.7*q,6.2])
                rotate([0,0,180]) post2();
            }
            
            for(q=[0:4]){
                translate([-33.5+16.7*q,-72,6.2])
                rotate([0,0,-90]) post2();
            }
            for(q=[0:4]){
                translate([-33.5+16.7*q,72,6.2])
