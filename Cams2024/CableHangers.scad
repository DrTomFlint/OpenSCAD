...
// fiber clip
difference(){
  translate([0,thick+2.4,0])
  rotate([0,90,0])
  cylinder(r=2.4+thick,h=wide,$fn=33);
  translate([0,thick+2.4,0])
  rotate([0,90,0])
  cylinder(r=2.4,h=wide,$fn=33);

  translate([0,thick,0])
  cube([wide,2*thick+1.5,5]);
  translate([22,-1,-10])
  cube([10,8*thick,30]);
}
...
//----------------------------------------------------------------------
// adjust for use with Ethernet cables
module hangEther(){
wide=26;
thick=1.2;
gap=7;
...
// fiber clip
difference(){
  translate([0,thick+2.7,0])
  rotate([0,90,0])
  cylinder(r=2.7+thick,h=wide,$fn=33);
  translate([0,thick+2.7,0])
  rotate([0,90,0])
  cylinder(r=2.7,h=wide,$fn=33);
