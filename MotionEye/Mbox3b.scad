...
translate ([12,-8,25.1]) color("red") 
    ...
    text("M1", font = "Open Sans:style=plain", size=16,halign="center",valign="center",spacing=1.3);
    }
      
// cut tiny holes in posts for the pi
// don't go all the way thru to the top surface
translate([52.5,81.5,4.0]){
    cylinder(r1=1.5,r2=2.5,h=20.5,$fn=8);
}    
translate([52.5,23.5,4.0]){
    cylinder(r1=1.5,r2=2.5,h=20.5,$fn=8);
}    
translate([3.5,81.5,4.0]){
    cylinder(r1=1.5,r2=2.5,h=20.5,$fn=8);
}    
translate([3.5,23.5,4.0]){
    cylinder(r1=1.5,r2=2.5,h=20.5,$fn=8);
}    
