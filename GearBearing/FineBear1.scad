...
approximate_number_of_teeth_on_sun=35;
// pressure angle
P=22;//[30:60]
	...
	for(i=[1:m])rotate([0,0,i*360/m+phi])translate([pitchD/2*(ns+np)/nr,0,0])
		rotate([0,0,i*ns/m*360/np-phi*(ns+np)/np-phi]){
            ...
            difference(){
                ...
                translate([0,0,-T]) cylinder(h=2*T, r1=1.5, r2 = 1.5, $fn=16);
            }
        }
}
...
translate([0,0,T/2+-1]){
    rotate(a=[-90,0,0]){
        intersection(){
            ...
            translate([0,-2,0]) text("Leverett Laboratory", font = "Open Sans:style=Bold", size=2.5,halign="center");
            }
