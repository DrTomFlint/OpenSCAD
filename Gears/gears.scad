...
worm_gear(modul=1, tooth_number=44, thread_starts=1, width=6, length=20, worm_bore=1.7, gear_bore=38, pressure_angle=20, lead_angle=10, optimized=1, together_built=1, show_spur=1, show_worm=1);
